...
class pipe:
    ...
    def set_height(self):
        self.height = random.randrange(50, 459)
...
def draw_win(win, Birds, Pipes, Base, score, my_font, GEN):

    win.blit(BG_IMG, (0, 0))
    Score = my_font.render("SCORE: " + str(score), True, (0, 0, 0))
    win.blit(Score, (10, 10))
    gen = my_font.render("GEN: " + str(GEN), True, (0, 0, 0))
    win.blit(gen, (10, 50))
    for p in Pipes:
        p.draw(win)
    for Bird in Birds:
...
def main(genomes, config):
    ...
    score = 0
    my_font = pygame.font.SysFont('comicsans', 32)
    ...
    while run and len(Birds) > 0:
        ...
        draw_win(win, Birds, Pipes, Base, score, my_font, GEN)
